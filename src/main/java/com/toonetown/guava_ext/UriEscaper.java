...
/**
 * An escaper that properly handles java URIs according to RFC 2396.  This is a quick-and-dirty (character by character)
 * encoding - and not a full parsing.  It is possible, for example, to have a character that is not allowed in the
 * host to exist.  This escaper also errs on the side of over-escaping while within the query portion of the string.
 */
@Slf4j
